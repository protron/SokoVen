...
namespace SokoVen {
  ...
  public class ErrorSokoVen : ApplicationException {
    ...
    public ErrorSokoVen(string msg, Exception inner) : base(msg + '\n' +
        inner.Message, inner) {}
  }
  ...
  public class MovidaInvalida : ErrorSokoVen {
    ...
    public MovidaInvalida(string msg, Exception inner) : base(
  ...
  public class FueraDelMapa : MovidaInvalida {
    ...
    public FueraDelMapa(string msg, Point posicion) : base(msg) {
